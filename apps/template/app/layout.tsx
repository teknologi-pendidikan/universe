...
export default function RootLayout({
  ...
  const jsonLd: WithContext<Organization> = {
    ...
    image: `${GlobalSiteContent.globalContentData.url}/images/icon-512x512.png`,
    description: GlobalSiteContent.globalContentData.description,
    url: GlobalSiteContent.globalContentData.url,
    subOrganization: [
      {
        ...
        logo: `${GlobalSiteContent.globalContentData.url}/images/logo-512x512.png`,
      },
      {
        '@type': 'Organization',
      ...
      },
      {
        ...
        url: `${GlobalSiteContent.globalContentData.url}/`,
        logo: `${GlobalSiteContent.globalContentData.url}/images/icon-512x512.png`,
      },
    ],
